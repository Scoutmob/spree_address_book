Deface::Override.new(
  ...
  :insert_before => %q{[data-hook=billing_fieldset_wrapper] erb[loud]:contains("render :partial => 'spree/address/form'")},
...
Deface::Override.new(
  ...
  :insert_before => %q{[data-hook=shipping_fieldset_wrapper] erb[loud]:contains("render :partial => 'spree/address/form'")},
